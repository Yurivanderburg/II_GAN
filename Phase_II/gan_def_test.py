...
mfn.gan_para(LAMBDA=100, OUTPUT_CHANNELS = 1, filtersize = 5, beta = 0.005, learning_rate = 2e-4, disc_train_iterations = 2)
...
mfn.fit(generator, discriminator, train_dataset, test_dataset, steps=5000)
