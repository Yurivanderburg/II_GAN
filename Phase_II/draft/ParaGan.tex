...
\begin{figure*}
	...
	\label{fig:GAN}
\end{figure*}
Here, we discuss the parameters for the GAN structure, which is trained to reconstruct the image of stellar objects using II. Due to the adversarial nature of GANs, where the generator and discriminator compete in a min-max game, careful tuning of key parameters ensures that both networks converge properly.
...
\begin{figure*}
	...
	\begin{subfigure}{0.33\linewidth}
		...
		\label{fig:mom6}
	\end{subfigure}\hfill
	\caption{The second-order central moments provide information about the size and shape of stellar objects.}
	\label{fig:struc}
\end{figure*}
\begin{figure*}
	\centering
	...
	\begin{subfigure}{0.50\linewidth}
		...
		\label{fig:mom10}
	\end{subfigure}\hfill
	\caption{This figure shows the 3rd-order central moments for reconstructed images and represents the brightness distribution.}
	\label{fig:moments}
\end{figure*}
