...
\begin{figure*}
	\centering
	\includegraphics[width=0.45\linewidth]{fig/analysis/Discrep_Runs_Losses_disc_loss.png}\hfil
	\includegraphics[width=0.45\linewidth]{fig/analysis/Discrep_Runs_Losses_gen_total_loss.png}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.45\linewidth]{fig/analysis/Telescope_Runs_Losses_disc_loss.png}\hfil
	\includegraphics[width=0.45\linewidth]{fig/analysis/Telescope_Runs_Losses_gen_total_loss.png}
