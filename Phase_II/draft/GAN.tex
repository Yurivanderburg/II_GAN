...
\begin{figure}
	...
	\caption{The number of episodes of Discriminator training per every episode of Generator training (termed Discriminator repetition or Disc. rep.), understandably, has a higher impact on the Discriminator loss than on the Generator loss. The top and the bottom panel show this effect on the square root of cumulative mean of Discriminator loss and the Generator loss respectively.}
