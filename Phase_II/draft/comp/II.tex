...
\begin{figure}
	...
	\caption{A schematic representation of a hypothetical observation facility with an the array of four Cherenkov Telescopes (IACTs) whose relative positions approximately mimic those at VERITAS. This array is used in simulating the II observation of the fast rotators. Each of the telescopes has a diameter of 12m. The baselines provided by the array are of the order of 100m.}
	\label{fig:teles}
\end{figure}
