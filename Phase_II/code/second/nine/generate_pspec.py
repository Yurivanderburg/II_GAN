...
base = np.load("../result/nine/base_npy/base.npy")                                                                   # the baseline in .npy format
path_in = "../result/ellip_npy/"                                                                                # the ellipsoid image in .npy format
counter = 0
for filename in os.listdir(path_in):
    ...
    if save_images:
       ...
       if rnd < 0.1:  # 10% for validation
            save_path = os.path.join("../result/nine/val", image_name + ".jpg")
            '''
            ...
            save_path = os.path.join("../result/nine/test", image_name + ".jpg")
            '''
            im = plt.imshow(combined_image, cmap='gray', aspect='equal')
            cbar = plt.colorbar(im, shrink=0.45, fraction=0.046, pad=0.04)
            cbar.ax.tick_params(labelsize=12, width=1.5)
            ...
            plt.close()
            '''
            save_path = os.path.join("../result/nine/train", image_name + ".jpg")
